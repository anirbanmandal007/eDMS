...
// console.log("hhh",this.filteredOptions);
    ...
    geBranchList(userid: any) {
      ...
      this.searchService.GetBranchByDeptIDANDUserwise(userid).subscribe((data: any) => {
  ...
  //    console.log("data : -", data);
   ...
   //   const apiUrl =this._global.baseAPIUrl +"SubFolderMapping/GetDetails?ID="+userid+"&user_Token="+this.EntityMappingForm.get("User_Token").value;;
      //const apiUrl=this._global.baseAPIUrl+'BranchMapping/GetList?user_Token=123123'
      this.searchService.GetSubFolderByBranch(this.ContentSearchForm.get("BranchID").value).subscribe((res) => {
        this.EntityList = res;
        this.ContentSearchForm.controls['SubfolderID'].setValue(0);
        //  this.checkbox_list = [];
...
//       }
      ...
      Setfavourite(FileName: any) {
        ...
        this.searchService.Setfavourite(this.ContentSearchForm.value)
        .subscribe( data => {
          this.toaster.show('success', 'Success!', 'Doc Type has been added as favourite');
...
// TODO
    ...
    GetDocumentDetails(row: any) {      
      ...
      this.searchService.GetDocumentDetails(row.AccNo).subscribe((data: [any]) => {
...
GetFilterData(tempID:any) {
 ...
 this.searchService.getSearchDataByFilter(this.ContentSearchForm.value). 
 subscribe((data: [any]) => {
       this._FileList = data;
       this._FilteredList = data;
